...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "hhngdcz");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.hhh");
